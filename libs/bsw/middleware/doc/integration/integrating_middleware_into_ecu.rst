...
* **CMake**: add a source file defining the functions to any library that
  ...
  ``executables/referenceApp/middlewareConfiguration/src/platform_integration/time/SystemTimeProvider.cpp``
...
* **CMake**: add a source file defining the functions to any library that
  links ``middleware``/``middlewareInterfaces`` (see
  ``executables/referenceApp/middlewareConfiguration/src/platform_integration/logger/LoggerImpl.cpp``
  for the reference implementation).
...
* **CMake**: add a source file defining the function to any library that
  links ``middleware``/``middlewareInterfaces`` (see
  ``executables/referenceApp/middlewareConfiguration/src/platform_integration/os/OsDefinitions.cpp``
  for the reference implementation).
