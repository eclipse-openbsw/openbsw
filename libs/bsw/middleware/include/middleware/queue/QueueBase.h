...
protected:
    ...
    void init(uint32_t const maxSize)
    {
        ...
        sent_                        = 0U;
        received_                    = 0U;
        stats_.processedMessages     = 0U;
        stats_.lostMessages          = 0U;
        stats_.loadSnapshot          = 0U;
        stats_.processingCounter     = 0U;
        stats_.realLoadSnapshot      = 0U;
        stats_.realProcessingCounter = 0U;
        stats_.maxLoad               = 0U;
        stats_.startupLoad           = 0U;
        stats_.previousSnapshot      = 0U;
        stats_.maxFillRate           = 0U;
    }
