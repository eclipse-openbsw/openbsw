...
ETL_INLINE_VAR constexpr MemberId MAX_METHOD_ID = 128U;
ETL_INLINE_VAR constexpr ClusterId INVALID_CLUSTER_ID
    = static_cast<ClusterId>(etl::numeric_limits<etl::underlying_type_t<ClusterId>>::max());
ETL_INLINE_VAR constexpr ServiceId INVALID_SERVICE_ID   = etl::numeric_limits<ServiceId>::max();
ETL_INLINE_VAR constexpr InstanceId INVALID_INSTANCE_ID = etl::numeric_limits<InstanceId>::max();
ETL_INLINE_VAR constexpr RequestId INVALID_REQUEST_ID   = etl::numeric_limits<RequestId>::max();
