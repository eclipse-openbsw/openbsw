...
public:
    ...
    /**
     * Construct a LegacyTxAdapter filling the TxAdapterTable from the provided memory.
     */
    LegacyTxAdapter(
        ::io::IWriter& outputWriter, ::etl::span<uint8_t const> config, ErrorHandler errorHandler);
