...
Install Rust 1.96.0 to be compatible with the CI builds and add the ARM target:

.. code-block:: bash

    curl --proto '=https' --tlsv1.2 -sSf https://sh.rustup.rs | sh -s -- --default-toolchain 1.96.0
